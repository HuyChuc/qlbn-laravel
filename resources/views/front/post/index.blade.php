                                ...
                                <header class="entry-header">
                                    <figure>
                                        <a href="openpost.html" class="preloader" title="Standard Post With an Image">
                                            <img width="710" height="400" src="{{$post->getMediaUrl()}}" class="fullwidth wp-post-image" alt="Standard Post With an Image" title="Standard Post With an Image" />				
                                        </a>
                                    </figure>
                                    ...
                                    <div class="cmsms_post_info">
                                        <span class="cmsms_post_month">{{date('d M, Y', strtotime($post->published_at))}}</span>
                                    </div>
                                </header>
