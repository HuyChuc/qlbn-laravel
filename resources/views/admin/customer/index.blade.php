                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'code'">{{ trans('admin.customer.columns.code') }}</th>
                                    <th is='sortable' :column="'full_name'">{{ trans('admin.customer.columns.full_name') }}</th>
                                    <th is='sortable' :column="'phone'">{{ trans('admin.customer.columns.phone') }}</th>
                                    <th is='sortable' :column="'gender'">{{ trans('admin.customer.columns.gender') }}</th>
                                    <th is='sortable' :column="'address'">{{ trans('admin.customer.columns.address') }}</th>
                                    <th is='sortable' :column="'group'">{{ trans('admin.customer.columns.group') }}</th>
                                    <th is='sortable' :column="'NHOMBENH'">{{ trans('admin.customer.columns.NHOMBENH') }}</th>
                                    <th is='sortable' :column="'dob'">{{ trans('admin.customer.columns.dob') }}</th>
