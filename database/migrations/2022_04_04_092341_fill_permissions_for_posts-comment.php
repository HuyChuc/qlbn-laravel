...
class FillPermissionsForPostsComment extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPostsComment constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.posts-comment',
            'admin.posts-comment.index',
            'admin.posts-comment.create',
            'admin.posts-comment.show',
            'admin.posts-comment.edit',
            'admin.posts-comment.delete',
            'admin.posts-comment.bulk-delete',
        ]);
