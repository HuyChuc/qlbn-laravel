...
class FillPermissionsForCustomersHistory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCustomersHistory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.customers-history.index',
            'admin.customers-history.create',
            'admin.customers-history.show',
            'admin.customers-history.edit',
            'admin.customers-history.delete',
            'admin.customers-history.bulk-delete',
        ]);
