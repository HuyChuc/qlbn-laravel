...
class FillPermissionsForCustomersPrescription extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCustomersPrescription constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.customers-prescription',
            'admin.customers-prescription.index',
            'admin.customers-prescription.create',
            'admin.customers-prescription.show',
            'admin.customers-prescription.edit',
            'admin.customers-prescription.delete',
            'admin.customers-prescription.bulk-delete',
        ]);
